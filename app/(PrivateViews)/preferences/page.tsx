...
const page = async () => {
    ...
    const page = await getClientProviderPageInfo(session?.user.client_provider, 'preferences')
                        ...
                        <div className='px-4'>
                            <div className='pt-4 flex flex-col'>
                                ...
                                <div className="flex flex-col sm:items-end">
                                    <p className='text-slate-500 dark:text-slate-400'>You can manually toggle between enabled and disabled. When enabled, we are going to send you important messages related to your account and activities. We will NEVER send you spams.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='px-4'>
                            <div className='pt-4 flex flex-col'>
                                <div className="flex items-center justify-between gap-5">
                                    ...
                                    <ThemeSwitcherButton session={session as Session} placement='preferences' />
                                </div>
                                <hr className="h-px my-4 border-gray-200 dark:border-slate-700"></hr>
                                <div className="flex flex-col sm:items-end">
