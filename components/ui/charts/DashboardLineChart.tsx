...
const DashboardLineChart = ({data, isPending, colors, theme, dict} : TLineChartProps) => {
    return (
                ...
                !isPending ? (
                    <ResponsiveContainer width="100%" height="100%">
                        <LineChart width={300} height={100} data={data} defaultShowTooltip={true}>
                            ...
                            />
                            <Tooltip content={<CustomTooltip dict={dict} />} cursor={{stroke: theme === 'light' ? '#e2e8f0' : '#090f1d', strokeWidth: 1}}/>
                        </LineChart>
                    </ResponsiveContainer>
                ) : null
            }
